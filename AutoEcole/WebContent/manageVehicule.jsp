...
<%  DaoVehicule dao = (DaoVehicule) Appfactory.getInstance().getModel("DaoVehicule");%>
  ...
  <table class="table">
   ...
   <c:forEach var="p" items="<%= dao.findAll() %>" > 
       <tr class="active">
         ...
         <td><a href="Vehiculectrl?action=modifier&numv=${p.numv}" >Modifier</a></td>
		 <td><a href="Vehiculectrl?action=supprimer&numv=${p.numv}" onclick="return confirm('Voulez vous supprimer')">Supprimer</a></td>
      </tr>
