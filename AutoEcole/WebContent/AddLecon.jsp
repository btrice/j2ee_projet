...
<div class="container">
  ...
  <div class="panel panel-info">
    <div class="panel-heading">Ajouter une leçon</div>
    ...
    <form role="form" action="Leconctrl?action=ajouter" method="post" >
   <form class="form-horizontal">
        <div class="form-group" style="padding: 20px;">
            <label for="date cours" class="control-label col-xs-2">Date cours</label>
            <div class="col-xs-10">
                <input type="text" class="form-control" name="dateCours" placeholder="date">
            </div>
        </div>
        ...
        <div class="form-group" style="padding: 20px;">
            ...
            <div class="col-xs-10">
                <input type="text" class="form-control" name="heurDebut" placeholder="Heure">
            </div>
        </div>
        ...
        <div class="form-group" style="padding: 20px;">
            ...
            <div class="col-xs-10">
                <input type="text" class="form-control" name="duree" placeholder="Durée">
            </div>
        </div>
        ...
        <div class="form-group" style="padding: 20px;">
		    ...
		    <div class="col-xs-10">
			      <select class="form-control" name="nume">
			       <c:forEach var="p" items="<%= eleve.findAllId() %>" > 
      	...
      	<div class="form-group" style="padding: 20px;">
		    ...
		    <div class="col-xs-10">
			      <select class="form-control" name="numm">
			        <c:forEach var="p" items="<%= moniteur.findAllId() %>" > 
			      <option value="${p}">${p}</option>
			        </c:forEach>
		      	 </select>
		      	 </div>
