...
<div class="container">
  ...
  <div class="panel panel-info">
    <div class="panel-heading">Modifier une séance</div>
    ...
    <form role="form" action="Seancectrl?action=edit" method="post" >
   <form class="form-horizontal">
         
          <div class="form-group" style="padding: 20px;">
            <label for="date" class="control-label col-xs-2">Date</label>
            <div class="col-xs-10">
               <label for="dates" class="control-label">${ladate}</label>
                <input type="hidden" class="form-control" name="dates" value="${ladate}">
            </div>
        </div>

        <div class="form-group" style="padding: 20px;">
            <label for="heure" class="control-label col-xs-2">Heure</label>
            <div class="col-xs-10">
               <label for="heure" class="control-label">${p.id.heures}</label>
                <input type="hidden" class="form-control" name="heures" value="${p.id.heures}">
            </div>
        </div>
