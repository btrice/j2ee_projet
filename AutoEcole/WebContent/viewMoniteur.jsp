...
<title>Informations du Moniteur</title>
</head>
<body>
...
<div class="container">
  ...
  <div class="panel panel-info">
    <div class="panel-heading">Informations du Moniteur</div>
   ...
   <form class="form-horizontal">
        <div class="form-group" style="padding: 20px;">
            ...
            <div class="col-xs-10">
                <label for="nom" class="control-label col-xs-2">${p.nom}</label>
            </div>
        </div>
        ...
        <div class="form-group" style="padding: 20px;">
            ...
            <div class="col-xs-10">
            <label for="prenom" class="control-label col-xs-2">${p.prenom}</label>
            </div>
        </div>
