...
<div class="container">
  ...
  <div class="panel panel-info">
    ...
    <form role="form" action="Vehiculectrl?action=ajouter" method="post" >
   <form class="form-horizontal">
        <div class="form-group" style="padding: 20px;">
            <label for="nom" class="control-label col-xs-2">Modèle</label>
            <div class="col-xs-10">
                <input type="text" class="form-control" name="model" placeholder="Modéle">
            </div>
        </div>
        ...
        <div class="form-group" style="padding: 20px;">
            ...
            <div class="col-xs-10">
                <input type="text" class="form-control" name="imma" placeholder="imma">
            </div>
        </div>
